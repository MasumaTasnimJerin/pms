...
Route::group(['middleware'=>['auth']],function(){
  Route::group(['middleware'=>['_pharmacist']],function(){
    Route::get('/pharmacist', 'DashboardController@pharmacist_dashboard')->name('pharmacist_dashboard');
...
Route::get('/supplier_edit/{id}','SupplierController@edit')->name('supplier.edit');
...
Route::get('/stock_list','StockController@stock_list')->name('stock_list');
Route::get('/stock_edit/{id}','StockController@edit')->name('stock.edit');
Route::post('/stock_update/{id}','StockController@update')->name('stock.update');
Route::get('/stock_delete/{id}','StockController@delete')->name('stock.delete');
...
Route::get('/expense_edit/{id}','ExpenseController@edit')->name('expense.edit');
Route::post('/expense_update/{id}', 'ExpenseController@update')->name('expense.update');
Route::get('/expense_delete/{id}', 'ExpenseController@delete')->name('expense.delete');
});
